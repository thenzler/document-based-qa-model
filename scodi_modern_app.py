"""
SCODi 4P Modernes Design - Dokumentenbasiertes QA-Modell
=================================================

Modernisierte Version des document-based-qa-model mit minimalem SCODi 4P Design
...
SCODI_DESIGN = {
    ...
    # Design-Typ (modern oder classic)
    "design_type": "modern"
}
...
# Hauptrouten mit SCODi 4P Modern Design
@app.route('/')
def index():
...
@app.route('/qa')
def qa_page():
    # Hier würden wir modern_qa.html verwenden, wenn sie existieren würde
...
def documents_page():
    ...
    # Hier würden wir modern_documents.html verwenden, wenn sie existieren würde
...
@app.route('/churn')
def churn_page():
    # Hier würden wir modern_churn.html verwenden, wenn sie existieren würde
    return render_template('churn.html', 
                          using_llm=is_using_llm,
                          design=SCODI_DESIGN,
                          page_title="SCODi 4P - Churn-Prediction")

# API-Endpunkte bleiben weitgehend unverändert
